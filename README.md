...
- Describe standalone images, embedded DOCX images, and embedded PDF images with `gpt-4o-mini`.
...
- Limits PDF and DOCX visual analysis to the first `MAX_VISUAL_IMAGES` embedded images found.
...
- Visual PDF analysis extracts embedded images directly; vector-only figures are not converted into page screenshots.
